...
typedef enum {
  CFF_ROTATE_WITH_ENTITY = 0x1,         /* Sets the camera's rotation to the followed entity's rotation */
  CFF_OFFSET_WITH_ROTATION = 0x10,      /* Modifies the camera's offset by rotating it around the entity by thier rotation value */
  CFF_INVERT_SCALE_WITH_ENTITY = 0x100, /* Sets the camera's scale to be the inverse of the followed entity's scale */
  CFF_OFFSET_WITH_SCALE = 0x1000,       /* Modifies the camera's offset by scaling it by the thier scale value */
